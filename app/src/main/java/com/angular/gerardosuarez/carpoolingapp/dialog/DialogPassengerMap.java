...
import com.angular.gerardosuarez.carpoolingapp.preference.map.MapPreference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (requestInfo != null) {
            if (requestInfo.getFromOrTo() != null) {
                ...
                String hour = StringUtils.formatHour(requestInfo.getHour())+requestInfo.getIntervalo();
