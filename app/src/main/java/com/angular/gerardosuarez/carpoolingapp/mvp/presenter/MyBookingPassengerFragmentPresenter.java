...
public class MyBookingPassengerFragmentPresenter extends BaseFragmentPresenter {
    ...
    private void processDriverInfoRequest(DataSnapshot dataSnapshot) {
        ...
        Log.e("MYUID",dataSnapshot.toString());
    ...
    public void onWpClicked(Context c){
        if (currentDriverInfo != null) {
            if(!TextUtils.isEmpty(currentDriverInfo.getDriverPhone())){
                String url = "https://api.whatsapp.com/send?phone=";
                String phone = currentDriverInfo.getDriverPhone();
                if(phone.contains("+57")){
                ...
                Toast.makeText(c, "No hay teléfono disponible ", Toast.LENGTH_SHORT).show();
            }
        }
    }
