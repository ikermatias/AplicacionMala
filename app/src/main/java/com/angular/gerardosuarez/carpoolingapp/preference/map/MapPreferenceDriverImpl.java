package com.angular.gerardosuarez.carpoolingapp.preference.map;

import android.content.Context;

import com.angular.gerardosuarez.carpoolingapp.preference.BasePreferenceImpl;
...
public class MapPreferenceDriverImpl extends BasePreferenceImpl implements MapPreference {
    ...
    private static final String INTERVALO = "INTERVALO_PASAJERO";
    ...
    private static final String ADDRESS = "ADDRESS_DRIVER";
    ...
    @Override
    public void agregarIntervarlo(String valor) {
